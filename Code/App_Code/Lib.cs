...
public static class Lib
{
    ...
    public static string getShippingAddress(string data) {
        dynamic address = JsonConvert.DeserializeObject<ExpandoObject>(data);
        return address.recipient_name + ", " + address.line1 + ", " + address.city + ", " + address.state + " " + address.postal_code + " " + address.country_code;
    }
    ...
    public static long Money(this MatHang data) {
        return (long)(data.GiamGia.HasValue && data.GiamGia.Value > 0 ? data.GiaBan - data.GiamGia.Value : data.GiaBan);
    }
