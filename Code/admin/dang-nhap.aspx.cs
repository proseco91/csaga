...
public partial class admin_dang_nhap : BasePage
{
    ...
    protected void btnInsert_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Admin _adminLogin = sql.Admins.Where(d => (d.UserName.ToLower().Equals(txtLogin) || d.Email.ToLower().Equals(txtLogin)) && d.Password.Equals(Lib.createMd5(txtPass.Text))).FirstOrDefault();
            if (_adminLogin == null)
            {
