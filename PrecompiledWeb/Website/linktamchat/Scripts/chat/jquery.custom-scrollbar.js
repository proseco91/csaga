(function ($) {
    ...
    $.fn.customScrollbar = function (options, args) {
        ...
        Scrollable.prototype = {
            ...
            scrollNew: function (element) {
                if (element == "bottom") {
                    this.vScrollbar.scrollOverviewTo(this.$overview.outerHeight(), true);
                } else if (element == "top") {
                    this.vScrollbar.scrollOverviewTo(0, true);
        ...
        Scrollbar.prototype = {
            ...
            setUnselectable: function (element, value) {
                ...
                if (value == null)
                    this.scrollable.$element.removeClass('mouseScroll');
                else
                    this.scrollable.$element.addClass('mouseScroll');
            },
